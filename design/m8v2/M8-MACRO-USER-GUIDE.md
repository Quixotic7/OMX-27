...
> Every view below has a faceplate map in [`doc-images/`](doc-images/) showing what each key does. They're generated with the [OMX-27 LED Designer](https://github.com/) and embedded per section.
